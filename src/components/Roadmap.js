...
import roadmapImage from "../icons/Union.png"; // твой экспорт из Figma (вместе со стрелками)
    ...
    <section className="roadmap">
      <div className="container">
        ...
        <div className="roadmap__image">
          <img src={roadmapImage} alt="GiftUp Roadmap" />
        </div>
        ...
        <div className="roadmap__stages">
          <div className="roadmap__stage">
            ...
            <p className="roadmap__desc">
              Finalization of whitepaper, token audit, and establishment of core
              smart contracts. Private seed funding and onboarding of the first
              retail partners.
            </p>
          </div>
          ...
          <div className="roadmap__stage">
            ...
            <p className="roadmap__desc">
              Release of GiftUp Web & Mobile App. Integration with TRON wallets
              and first NFT gift card campaigns.
            </p>
          </div>
          ...
          <div className="roadmap__stage">
            ...
            <p className="roadmap__desc">
              Implementation of DAO governance, listing on DEX & CEX exchanges.
              Expansion to new regions: Europe, USA, and Asia.
            </p>
          </div>
        </div>
